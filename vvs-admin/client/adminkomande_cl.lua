...
----------------------------------------------------------------------------------
RegisterNetEvent("vvs_admin:killPlayer")
AddEventHandler("vvs_admin:killPlayer", function()
  SetEntityHealth(PlayerPedId(), 0)
end)

RegisterNetEvent("vvs_admin:freezePlayer")
AddEventHandler("vvs_admin:freezePlayer", function(input)
...
-------- noclip --------------
local noclip = false
RegisterNetEvent("vvs_admin:noclip")
AddEventHandler("vvs_admin:noclip", function(input)
    local player = PlayerId()
    local msg = "disabled"
...
RegisterNetEvent("vvs_admin:marker")
AddEventHandler("vvs_admin:marker", function()
